...
export default function SubeFotos({ content }: { content: SiteContent }) {
  ...
  const disponible = Date.now() >= new Date(content.fechaBodaIso).getTime();
    ...
    <section id="fotos" className="mx-auto max-w-2xl px-6 py-24 text-center">
      ...
      {disponible ? (
        ...
        <p className="text-muted">
          Podrás subir tus fotos y vídeos aquí mismo el día de la boda.
        </p>
      )}
    </section>
  );
